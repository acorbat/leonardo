...
## 2. Texto Oficial del Resumen para la Plataforma (1.946 caracteres)

> [!IMPORTANT]
> **Conteo exacto verificado:** **1.946 caracteres** (con espacios y saltos de línea incluidos; límite de la convocatoria: máx. 2.000 caracteres).  
> **Enfoque de área:** Ciencias de la Computación, Ciencia de Datos e Inteligencia Artificial, articulando visión por computadora (HSVM), aprendizaje automático (TEM) y bioinformática genómica (*in-silico*) para resolver el cuello de botella del diagnóstico pediátrico de la DCP.  
> **Estructura narrativa:** Sin formato de lista (los objetivos específicos se detallan en la sección subsiguiente del formulario). Se focaliza en cómo las herramientas computacionales mejoran y objetivizan el diagnóstico, y en el impacto directo sobre el Hospital Gutiérrez como centro de referencia y derivación pediátrico nacional. Sin citas bibliográficas.

```text
Las Ciencias de la Computación, la Ciencia de Datos y la Inteligencia Artificial revolucionan el diagnóstico biomédico al aportar objetividad, velocidad y reproducibilidad en el análisis de datos complejos. Un caso paradigmático donde estas disciplinas resultan determinantes es la Disquinesia Ciliar Primaria (DCP), enfermedad genética considerada infrecuente (1:15.000 a 1:30.000) hasta que mejoras en el diagnóstico demostraron una prevalencia mucho más alta (al menos 1:7.500). En Argentina, el severo retraso diagnóstico (mediana: 8,8 años en el Hospital Gutiérrez) propicia tratamientos erróneos (52%) y deriva en daño pulmonar irreversible. En menores de 5 años, el óxido nítrico nasal (técnica habitual de screening) es inviable al requerir cooperación activa; por ello, la confirmación clínica depende ineludiblemente de la videomicroscopía de alta velocidad (HSVM), la microscopía electrónica (TEM) y la genética, métodos hoy limitados por análisis manuales, subjetivos y sin control térmico.

Para superar estas barreras, este proyecto conjunto entre la FCEN-UBA y el Hospital Gutiérrez implementará una plataforma computacional abierta que transformará el diagnóstico mediante visión artificial, aprendizaje automático y bioinformática in-silico. La modernización instrumental in situ con control térmico, combinada con algoritmos computacionales para HSVM y TEM, sustituirá la inspección visual manual por métricas cinéticas y ultraestructurales objetivas e independientes del operador. Asimismo, la priorización genómica con inteligencia artificial integrará el perfil molecular con el fenotipo funcional. Como centro de referencia y derivación pediátrica nacional, dotar al Hospital Gutiérrez de esta tecnología permitirá diagnosticar precozmente a niños menores de 5 años, instaurando terapias protectoras antes de la aparición de bronquiectasias irreversibles y consolidando un estándar público, cuantitativo y de código abierto.
```
